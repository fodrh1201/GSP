...
MemAllocInfo* SmallSizeMemoryPool::Pop()
{
	...
	MemAllocInfo* mem = reinterpret_cast<MemAllocInfo*>(InterlockedPopEntrySList(&mFreeList));//TODO: InterlockedPopEntrySList를 이용하여 mFreeList에서 pop으로 메모리를 가져올 수 있는지 확인. 
